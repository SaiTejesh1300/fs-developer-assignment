...
class __TwigTemplate_caefb3f7283ccf516167c9f4bb81e2fd extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 31
        yield "<div";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["toolbar-block"], "method", false, false, true, 31), 31, $this->source), "html", null, true);
        yield ">
  ";
        // line 32
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 34
            yield "    <h2";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", ["toolbar-block__title"], "method", false, false, true, 34), "setAttribute", ["data-drupal-tooltip", ($context["label"] ?? null)], "method", false, false, true, 34), "setAttribute", ["data-drupal-tooltip-class", "toolbar-block__title-tooltip"], "method", false, false, true, 34), 34, $this->source), "html", null, true);
            yield ">";
...
";
  ...
  ";
    ...
    {
        return new Source("", "core/modules/navigation/templates/block--navigation.html.twig", "/app/web/core/modules/navigation/templates/block--navigation.html.twig");
    }
