...
class __TwigTemplate_ed21cda12900557492aef8404399e7ea extends Template
{
  ...
  <rect fill=\"";
        // line 2
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((array_key_exists("bg_color", $context)) ? (Twig\Extension\CoreExtension::default($this->sandbox->ensureToStringAllowed(($context["bg_color"] ?? null), 2, $this->source), "#347efe")) : ("#347efe")), "html", null, true);
        yield "\" width=\"32\" height=\"32\" rx=\"8\"/>
  <path fill=\"";
        // line 3
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((array_key_exists("fg_color", $context)) ? (Twig\Extension\CoreExtension::default($this->sandbox->ensureToStringAllowed(($context["fg_color"] ?? null), 3, $this->source), "#fff")) : ("#fff")), "html", null, true);
